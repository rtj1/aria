# Roleplay jailbreaks beat persona injection ~4× in my automated red-team run (n=1,078)
...
I built an automated red-teaming harness (ARIA) and ran **1,078** independent jailbreak attempts (**77 variants × 14 behaviors**) against **Claude 3.5 Sonnet**.

Main results:

* **Roleplay** had 23.21% ASR, vs persona injection at 6.12% → ~3.79× (~4×) higher.
...
Code: [https://github.com/rtj1/aria](https://github.com/rtj1/aria)
...
Full sweep: 77 variants × 14 behaviors against Claude 3.5 Sonnet.
...
Main comparison: roleplay vs persona injection is ~4× (23.21% / 6.12% = 3.79×).
